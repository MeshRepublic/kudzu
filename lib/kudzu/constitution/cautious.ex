defmodule Kudzu.Constitution.Cautious do
  ...
  @impl true
  @doc """
  Bootstrap default — distillation is not implemented for `Cautious`.

  `Cautious` is a hand-coded restrictive framework, not the product of
  ...
  @impl true
  @doc """
  Bootstrap stub. The hand-coded `Cautious` constitution does not yet
