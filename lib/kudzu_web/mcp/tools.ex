defmodule KudzuWeb.MCP.Tools do
  ...
  @tools [
    ...
    %{
      name: "kudzu_health",
      description:
        "Health check. Returns status, node info, hologram count, Ollama availability.",
    ...
    %{
      ...
      description:
        "List all active holograms with their ID, purpose, constitution, trace count, and peer count.",
      inputSchema: %{
        type: "object",
    ...
    %{
      ...
      inputSchema: %{
        ...
        properties: %{
          ...
          constitution: %{
            type: "string",
            description: "Constitutional framework: mesh_republic, cautious, open, kudzu_evolve"
          },
    ...
    %{
      ...
      inputSchema: %{
        type: "object",
        properties: %{id: %{type: "string", description: "Hologram ID"}},
        required: ["id"]
      }
    },
    %{
    ...
    %{
      ...
      description:
        "Send a stimulus to a hologram for LLM cognition. Returns the response and any actions taken.",
      inputSchema: %{
        type: "object",
        properties: %{
      ...
      inputSchema: %{
        ...
        properties: %{
          ...
          purpose: %{
            type: "string",
            description:
              "Filter by purpose: observation, thought, memory, discovery, research, learning, session_context"
          },
      ...
      inputSchema: %{
        ...
        properties: %{
          ...
          purpose: %{
            type: "string",
            description:
              "Trace purpose: observation, thought, memory, discovery, research, learning, session_context"
          },
    ...
    %{
      ...
      inputSchema: %{
        ...
        properties: %{
          ...
          constitution: %{
            type: "string",
            description: "Framework: mesh_republic, cautious, open, kudzu_evolve"
          }
        },
    ...
    %{
      ...
      inputSchema: %{
        type: "object",
        properties: %{id: %{type: "string", description: "Trace ID"}},
        required: ["id"]
      }
    },
    %{
      ...
      inputSchema: %{
        ...
        properties: %{
          ...
          purpose: %{
            type: "string",
            description:
              "Filter by purpose: memory, learning, thought, observation, decision, discovery"
          },
    ...
    %{
      ...
      description:
        "Send a prompt to an agent for LLM cognition. Requires cognition to be enabled.",
      inputSchema: %{
        type: "object",
        properties: %{
          name: %{type: "string", description: "Agent name"},
    ...
    %{
      ...
      inputSchema: %{
        ...
        properties: %{
          name: %{
            type: "string",
            description: "Framework name: mesh_republic, cautious, open, kudzu_evolve"
          }
        },
        required: ["name"]
      }
    ...
    %{
      ...
      inputSchema: %{
        type: "object",
        properties: %{node: %{type: "string", description: "Node name (e.g. kudzu@host)"}},
        required: ["node"]
      }
    },
    %{
    ...
    %{
      ...
      description:
        "Get local node status: ID, data dir, mesh status, peers, storage stats, capabilities.",
      inputSchema: %{type: "object", properties: %{}, required: []}
    },
    %{
    ...
    %{
      ...
      inputSchema: %{
        type: "object",
        properties: %{node: %{type: "string", description: "Node to join"}},
        required: ["node"]
      }
    },
    %{
    ...
    %{
      ...
      inputSchema: %{
        type: "object",
        properties: %{id: %{type: "string", description: "Beamlet ID"}},
        required: ["id"]
      }
    },
    %{
    ...
    %{
      ...
      description:
        "Search traces by semantic similarity to a natural language query. Uses HRR token-seeded encoding with co-occurrence learning. Returns traces ranked by similarity.",
      inputSchema: %{
        type: "object",
        properties: %{
          query: %{
            type: "string",
            description: "Natural language query (e.g. 'supervisor crash restart')"
          },
          purpose: %{
            type: "string",
            description:
              "Filter by trace purpose: observation, thought, memory, discovery, research, learning, session_context"
          },
    ...
    %{
      ...
      description:
        "Show co-occurrence neighbors for a token. Reveals what concepts Kudzu has learned are related through trace processing.",
      inputSchema: %{
        type: "object",
        properties: %{
    ...
    %{
      ...
      description:
        "List known tokens and their frequency. Shows what concepts Kudzu has learned from processing traces.",
      inputSchema: %{
        type: "object",
        properties: %{
    ...
    %{
      ...
      description:
        "Get HRR encoder statistics: vocabulary size, co-occurrence entries, traces processed, top tokens.",
      inputSchema: %{type: "object", properties: %{}, required: []}
    },
    ...
    %{
      name: "kudzu_brain_status",
      description:
        "Get the Brain's current state: status (sleeping/reasoning), cycle count, desires, budget spent.",
      inputSchema: %{type: "object", properties: %{}, required: []}
    },
    # === Web Tools ===
    %{
      ...
      description:
        "Search the internet for information. Returns titles, URLs, and snippets. Uses SearXNG (self-hosted) with DuckDuckGo fallback.",
      inputSchema: %{
        type: "object",
        properties: %{
          query: %{type: "string", description: "Search query"},
    ...
    %{
      name: "kudzu_web_read",
      description:
        "Fetch a web page and extract its readable text content. Returns text, title, and word count. Max 100KB content.",
      inputSchema: %{
        type: "object",
        properties: %{
          url: %{
